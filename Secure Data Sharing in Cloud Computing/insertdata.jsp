...
<%
					...
					if ( rs1.next() )
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,location,imagess) values(?,?,?,?,?,?,?,?,?)");
			...
			%>
			<p><a href="EndUser.html">Back</a>         <a href="index.html">Home</a> </p>
