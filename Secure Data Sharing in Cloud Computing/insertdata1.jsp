...
<%
					...
					try {
						...
						PreparedStatement ps=connection.prepareStatement("insert into owner(name,pass,email,mobile,addr,dob,gender,location,imagess) values(?,?,?,?,?,?,?,?,?)");
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="DataProvider.html">Back</a>         <a href="index.html">Home</a> </p>
